...
impl<'a> xdp<'a> {
    ...
    pub fn tcp_header<'b>(&'b self, ctx: &'b xdp_md) -> &'b mut tcphdr {
        ...
        unsafe { convert_slice_to_struct_mut::<tcphdr>(&mut data_slice[34..54]) }
    }
    ...
    pub fn udp_header<'b>(&self, ctx: &'b xdp_md) -> &'b mut udphdr {
        ...
        unsafe { convert_slice_to_struct_mut::<udphdr>(&mut data_slice[34..42]) }
    }
    ...
    pub fn ip_header<'b>(&self, ctx: &'b xdp_md) -> &'b mut iphdr {
        ...
        unsafe { convert_slice_to_struct_mut::<iphdr>(&mut data_slice[14..34]) }
    }
